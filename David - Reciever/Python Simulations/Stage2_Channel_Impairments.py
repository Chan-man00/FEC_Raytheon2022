...
class Stage2_Channel_Impairments(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Channel_Impairments")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Channel_Impairments")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Stage2_Channel_Impairments")
...
def main(top_block_cls=Stage2_Channel_Impairments, options=None):
