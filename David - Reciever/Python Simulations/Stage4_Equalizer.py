...
class Stage4_Equalizer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Stage4_Equalizer")
        ...
        self.connect((self.digital_cma_equalizer_cc_0, 0), (self.qtgui_freq_sink_x_1, 0))
...
def main(top_block_cls=Stage4_Equalizer, options=None):
