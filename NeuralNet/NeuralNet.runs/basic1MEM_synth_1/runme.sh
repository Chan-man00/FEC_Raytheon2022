...
HD_PWD='C:/Users/18019/Documents/UofU/SPRING2023/capstoneProject/MemoryVHDL/NeuralNet/NeuralNet.runs/basic1MEM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basic1MEM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basic1MEM.tcl
