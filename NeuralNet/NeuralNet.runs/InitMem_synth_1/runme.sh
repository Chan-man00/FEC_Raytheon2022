...
HD_PWD='C:/Users/18019/Documents/UofU/SPRING2023/capstoneProject/MemoryVHDL/NeuralNet/NeuralNet.runs/InitMem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InitMem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InitMem.tcl
