...
#
# Generated by export_simulation on Wed Apr 12 10:08:06 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './basic1MEM.sh' script.

./basic1MEM.sh -reset_run
...
./basic1MEM.sh -noclean_files

For more information on the script, please type './basic1MEM.sh -help'.
