...
#
# Generated by export_simulation on Wed Apr 12 10:10:48 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './basic2MEM.sh' script.

./basic2MEM.sh -reset_run
...
./basic2MEM.sh -noclean_files

For more information on the script, please type './basic2MEM.sh -help'.
