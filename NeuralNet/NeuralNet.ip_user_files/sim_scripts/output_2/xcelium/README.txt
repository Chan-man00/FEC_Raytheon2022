...
#
# Generated by export_simulation on Mon Apr 17 09:52:07 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './output_2.sh' script.

./output_2.sh -reset_run
...
./output_2.sh -noclean_files

For more information on the script, please type './output_2.sh -help'.
