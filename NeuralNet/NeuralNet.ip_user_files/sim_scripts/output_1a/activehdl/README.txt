...
#
# Generated by export_simulation on Mon Apr 17 09:54:09 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './output_1a.sh' script.

./output_1a.sh -reset_run
...
./output_1a.sh -noclean_files

For more information on the script, please type './output_1a.sh -help'.
